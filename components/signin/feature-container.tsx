...
const FeatureContainer = () => (
  <HStack w="full" pb={16} gap={4}>
    <FeatureBox title="Experience">
      <Text>
        The Translate platform is a user-friendly web interface built on top of
        established technologies. It leverages the power of{" "}
    ...
    <FeatureBox title="Privacy">
      <Text>
        ...
        , ensuring your privacy. We never store your credentials or repository
        data on our server, prioritizing the security of your information.
      </Text>
    </FeatureBox>
